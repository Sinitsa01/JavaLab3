...
hboxRange.setPreferredSize(new Dimension(
		...
		// На основе считанных данных создать нов экземпляр модели таблицы
		...
		// В случае ошибки преобразования чисел показат сообщение об ошибке
		...
		hboxButtons.add(Box.createHorizontalGlue());
		// Установить предпочтительный размер области равным удвоенномуm минимальному, чтобы при
